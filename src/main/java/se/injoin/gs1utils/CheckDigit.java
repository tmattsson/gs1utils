...
/**
 * Utility methods for calculating and validating check digits as used by GS1 in data structures such as GTIN, GLN and
 * SSCC.
 *
...
public final class CheckDigit {
	 ...
	 *
	 * @throws IllegalArgumentException if the input string is null, not a sequence of at least two digits or if the
