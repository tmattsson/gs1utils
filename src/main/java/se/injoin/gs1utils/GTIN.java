...
public final class GTIN {
	 ...
	 *
	 * @throws NullPointerException     if the input string is null
	 * @throws IllegalArgumentException if the input string is not a sequence of 14, 13, 12 or 8 digits or if check
	 ...
	 *
	 * @throws IllegalArgumentException if the input string is not a GTIN or a GTIN-14, GTIN-13 or GTIN-12 without
	 *                                  leading zeros
	 */
