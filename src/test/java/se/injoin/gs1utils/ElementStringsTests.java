...
public class ElementStringsTests {
	...
	public void testParseFailsWhenNumericFixedTooShort() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 00 at position 0, data field must be exactly 18 characters long",
	...
	public void testParseFailsWhenNumericFixedNotNumeric() {
		ElementStrings.ParseResult result = ElementStrings.parse(
				SIMPLE_SSCC.substring(0, SIMPLE_SSCC.length() - 2) + "AB");
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 00 at position 0, data field must be numeric",
				result.getErrorMessage());
	}
	...
	public void testParseFailsWhenNumericVariableTooShort() {
		...
		assertEquals(
				"Error parsing data field for AI 255 at position 0, data field must be at least 13 characters long",
				result.getErrorMessage());
	}
	...
	public void testParseFailsWhenNumericVariableNotNumeric() {
		ElementStrings.ParseResult result = ElementStrings.parse(
				SIMPLE_GCN.substring(0, SIMPLE_GCN.length() - 2) + "AB");
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 255 at position 0, data field must be numeric",
				result.getErrorMessage());
	}
	...
	public void testParseDecimalFailsWhenDecimalPointIndicatorNotNumeric() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 310 at position 0, decimal point indicator must be a digit",
				result.getErrorMessage());
	}
	...
	public void testParseDecimalFailsWhenNotNumeric() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 310 at position 0, data field must be numeric",
				result.getErrorMessage());
	}
	...
	public void testParseDateFailsWhenTooShort() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 15 at position 0, data field must be exactly 6 characters long",
				result.getErrorMessage());
	}
	...
	public void testParseDateFailsWhenNotNumeric() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 15 at position 0, data field must be numeric",
				result.getErrorMessage());
	}
	...
	public void testParseDateRangeFailsWhenFieldTooShort() {
		...
		assertTrue(result.isEmpty());
		assertEquals(
				"Error parsing data field for AI 7007 at position 0, data field must be at least 6 characters long",
				result.getErrorMessage());
	}
	...
	public void testParseDateRangeFailsWhenFieldOfInvalidLength() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 7007 at position 0, invalid data field length",
				result.getErrorMessage());
	}
	...
	public void testParseDateAndTimeWithoutSecondsFailsWhenTooShort() {
		...
		assertTrue(result.isEmpty());
		assertEquals(
				"Error parsing data field for AI 7003 at position 0, data field must be exactly 10 characters long",
				result.getErrorMessage());
	}
	...
	public void testParseDateAndTimeWithoutSecondsFailsWhenNotNumeric() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 7003 at position 0, data field must be numeric",
				result.getErrorMessage());
	}
	...
	public void testParseDateAndTimeWithOptionalMinutesAndSecondsFailsWhenNotNumeric() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 8008 at position 0, data field must be numeric",
				result.getErrorMessage());
	}
	...
	public void testParseDateAndTimeWithOptionalMinutesAndSecondsFailsWhenTooShort() {
		...
		assertTrue(result.isEmpty());
		assertEquals(
				"Error parsing data field for AI 8008 at position 0, data field must be at least 8 characters long",
				result.getErrorMessage());
	}
	...
	public void testParseDateAndTimeWithOptionalMinutesAndSecondsFailsWhenInvalidLength() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 8008 at position 0, invalid data field length",
				result.getErrorMessage());
	}
	...
	public void testParseCountryOfInitialProcessingOfInvalidLength() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 423 at position 0, invalid data field length",
				result.getErrorMessage());
	}
	...
	public void testParseCountryOfInitialProcessingNotNumeric() {
		...
		assertTrue(result.isPartial());
		assertTrue(result.isEmpty());
		assertEquals("Error parsing data field for AI 423 at position 0, data field must be numeric",
				result.getErrorMessage());
	}
	...
	public void testParseRealWorldExample2() {
		ElementStrings.ParseResult result = ElementStrings.parse(
				"019739372006134231020007141517071010170411\u001D9010");
		assertFalse(result.isPartial());
		assertFalse(result.isEmpty());
	...
	public void testParseRealWorldExample3() {
		ElementStrings.ParseResult result = ElementStrings.parse(
				"011739119609790615170612310300120080050000001001714362");
		assertFalse(result.isPartial());
		assertFalse(result.isEmpty());
		assertEquals(5, result.getElementsByString().size());
